...
<script>
  ...
  function report(id){
    location.href = 'product_report_spec.php?id=' + id;
  }
</script>
<!-- MAIN SECTION -->
            ...
            <div class="col">
              <div class="d-flex justify-content-between buttonPosition">
                ...
                <div class="d-flex buttonPosition">
                  ...
                  <a href="product_report_full.php" class="btn btn-success me-2 mt-1">
                    <i class="fa fa-file-pen me-2"></i>Gerar Relatório Completo
                  </a>
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <form method="post" action="product_controller.php?action=insert">
                          ...
                          <div class="form-group">
                            <input type="text" name="anumber" class="form-control iconInput mb-2" placeholder="Patrimônio" required>
                          </div>
                          <div class="form-group">
                    ...
                    <tbody class="table-group-divider" >
                      ...
                      <td>
                        <div class="col-sm-2 mt-2 d-flex justify-content-between">
                          ...
                          <i class="fas fa-file-lines fa-lg text-success me-3" title="Gerar Relatório" onclick="report(<?= $product->id ?>)"></i>
