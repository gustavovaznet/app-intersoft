<?php
    ...
    $pdf->Ln(5);
    $pdf->Cell(190,10,utf8_decode('Comprovante de Recebimento'),0,0,"C");
    $pdf->Ln(15);
    $pdf->SetFont('Arial','',10);
    $pdf->Cell(190,10,utf8_decode('Declaro ter recebido da MGDATA TECNOLOGIA LTDA de CNPJ 23.936.997/0001-91 o seguinte produto/equipamento:'),0,0,"C");
    $pdf->Ln(15);
    //BODY
    ...
    $pdf->Ln(20);
    $pdf->SetFont('Arial','',10);
    $pdf->Cell(190,10,utf8_decode('________________________________________________________'),0,0,"C");
    $pdf->Ln(5);
